...
while True:
    ...
    if not grabbed:
        ...
        break
    # 调整大小，放入队列中
    frame = imutils.resize(frame, width=870)
    frames.append(frame)
    # 判断是否填充到最大帧数
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(r"C:\\Users\\22322\\Desktop\\UIUC\\ECE549\\final\\action\\code5\\activity-recognition-demo\\activity-recognition-demo\\videos\\output\\4.mp4",
